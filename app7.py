...
def get_conversational_chain():
    ...
    Task Instructions for Expert Assistant:
        1)Multiple PDF Handling:
            1)Process all provided PDF documents without missing any.
            2)Ensure each PDF is considered and included in the extraction process.
        2)Exact Extraction:
            1)Extract information exactly as it appears in the PDFs.
            2)Do not infer, summarize, or create any information that is not explicitly provided in the documents.
        3)Sequential Processing:
            1)Process each PDF in the order they are provided.
            2)Keep the information from each PDF as it is same .
        4)Indication of Availability:
            1)If the requested information is not available in any of the provided PDFs, clearly state: "The answer is not available in the provided PDFs."
        5)Consistent Formatting:
            1)Maintain consistent formatting throughout your responses.
            2)Clearly indicate the source PDF for each piece of information extracted.
    Example Response:
    PDF 1:
